...
var UseConnectorProvider = function (props) {
  var _ref = _sliced_to_array((0, import_react.useState)(null), 2),
    childWindow = _ref[0],
    setChildWindow = _ref[1]
  var _ref1 = _sliced_to_array((0, import_react.useState)(""), 2),
    requestType = _ref1[0],
    setRequestType = _ref1[1]
  var _ref2 = _sliced_to_array(
    ...
    transactionData = _ref2[0],
    setTransactionData = _ref2[1]
  var _import_react_default_useState = _sliced_to_array(import_react.default.useState(null), 2),
    requestData = _import_react_default_useState[0],
    setRequestData = _import_react_default_useState[1]
  var _import_react_default_useState1 = _sliced_to_array(
    ...
    createAssetData = _import_react_default_useState1[0],
    setCreateAssetData = _import_react_default_useState1[1]
  var _import_react_default_useState2 = _sliced_to_array(
      import_react.default.useState({
        assetId: 0,
        receiverAddress: "",
        supply: 0,
    ...
    transferAssetData = _import_react_default_useState2[0],
    setTransferAssetData = _import_react_default_useState2[1]
  var _import_react_default_useState3 = _sliced_to_array(
      import_react.default.useState({
        chainId: null,
        networkType: "",
      }),
    ...
    networkState = _import_react_default_useState3[0],
    setNetworkState = _import_react_default_useState3[1]
  var _import_react_default_useState4 = _sliced_to_array(
      import_react.default.useState({
        accountPublicKey: "",
    ...
    walletState = _import_react_default_useState4[0],
    setWalletState = _import_react_default_useState4[1]
  var _ref3 = _sliced_to_array(
      (0, import_react.useState)(localStorage.getItem("walletURL") || props.walletURL),
      2,
    ),
    walletURL = _ref3[0],
    setWalletURL = _ref3[1]
  var windowFeatures =
    "left=1000,top=100,width=370,height=550,fullscreen=yes,toolbar=no,menubar=no,scrollbars=no,resizable=no,location=no,directories=no, status=no, titlebar=no"
    ...
    if (event.data.type === "connection-response" /* connectionResponse */) {
      ...
      if (event.data.status) {
        if (
          ...
          requestType === "disconnect" /* disconnected */
        ) {
      ...
      event.data.type === "send-response" /* sendResponse */ ||
      event.data.type === "create-asset-response" /* createAssetResponse */
    ) {
      childWindow.close()
      resolvePromise({
        status: event.data.status,
        result: event.data.status ? event.data : null,
        error: event.data.status ? null : event.data,
      })
