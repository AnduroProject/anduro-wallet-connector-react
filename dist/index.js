...
var useWallet = function() {
    var _ref = _sliced_to_array((0, import_react.useState)(walletInformation), 2), walletInfo = _ref[0], setWalletInfo = _ref[1];
...
var useConnector = function(props) {
    ...
    var _ref = _sliced_to_array((0, import_react2.useState)(null), 2), childWindow = _ref[0], setChildWindow = _ref[1];
    var _ref1 = _sliced_to_array((0, import_react2.useState)(""), 2), requestType = _ref1[0], setRequestType = _ref1[1];
    var _ref2 = _sliced_to_array((0, import_react2.useState)({
        transactionType: "",
        amount: 0,
        receiverAddress: "",
        feeRate: 1,
    ...
    var _import_react2_default_useState = _sliced_to_array(import_react2.default.useState(null), 2), requestData = _import_react2_default_useState[0], setRequestData = _import_react2_default_useState[1];
    var _import_react2_default_useState1 = _sliced_to_array(import_react2.default.useState({
        name: "",
        symbol: "",
        imageUrl: "",
        supply: 0,
        ...
        receiverAddress: "",
        onComplete: null
    }), 2), createAssetData = _import_react2_default_useState1[0], setCreateAssetData = _import_react2_default_useState1[1];
    var _import_react2_default_useState2 = _sliced_to_array(import_react2.default.useState({
        assetId: 0,
        receiverAddress: "",
        supply: 0,
        onComplete: null
    }), 2), transferAssetData = _import_react2_default_useState2[0], setTransferAssetData = _import_react2_default_useState2[1];
